 ...
 * Handles user registration, authentication, and profile management with BCrypt password encoding.
 * 
 * การใช้งาน UserService สำหรับการจัดการผู้ใช้ รวมถึงการลงทะเบียน การยืนยันตัวตน และการจัดการโปรไฟล์
 */
@Slf4j
@Service
