...
/**
 * Implementation of ProductService for product management operations.
 * Handles product search, filtering, inventory management, and CRUD operations.
 * 
 * การใช้งาน ProductService สำหรับการจัดการสินค้า
...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    @Transactional(readOnly = true)
    public Page<Product> findProductsByCategory(UUID categoryId, boolean includeSubcategories, 
                                               boolean activeOnly, Pageable pageable) {
        log.debug("Finding products by category ID: {}, includeSubcategories: {}, activeOnly: {}", 
    ...
    public Page<Product> findProductsByPriceRange(BigDecimal minPrice, BigDecimal maxPrice, 
                                                  boolean activeOnly, Pageable pageable) {
        log.debug("Finding products by price range: {} to {}, activeOnly: {}", minPrice, maxPrice, activeOnly);
    ...
    @Override
    @Transactional(readOnly = true)
    public Page<Product> findProductsWithAvailableStockByCategory(UUID categoryId, 
                                                                 boolean includeSubcategories, 
                                                                 Pageable pageable) {
        log.debug("Finding products with available stock by category ID: {}, includeSubcategories: {}", 
                 categoryId, includeSubcategories);
    ...
    public Product createProduct(String name, String description, BigDecimal price, 
                                UUID categoryId, String server, String imageUrl, 
                                Integer sortOrder, Integer lowStockThreshold) {
    ...
    @Override
    @Transactional
    public Product updateProductSettings(UUID productId, Integer sortOrder, Integer lowStockThreshold) {
    ...
    public void deleteProduct(UUID productId) {
        ...
        if (!canDeleteProduct(productId)) {
            throw new IllegalStateException("Cannot delete product that has stock items or is referenced in orders");
        }
