...
public interface OrderService {
    ...
    /**
     * Create a new order for a user with specified products and quantities.
     * This method handles stock reservation and order validation.
     * 
     ...
     * @throws com.accountselling.platform.exception.ResourceNotFoundException if user or product not found
     * @throws com.accountselling.platform.exception.InsufficientStockException if insufficient stock available
    ...
    /**
     * Create a new order for a user with a single product.
     * Convenience method for single-product orders.
     * 
     * @param user the user creating the order
     ...
     * This typically happens when payment is initiated.
     * 
     * @param orderId the order ID to update
     * @return the updated order
     * @throws com.accountselling.platform.exception.ResourceNotFoundException if order not found
     * @throws com.accountselling.platform.exception.InvalidOrderStatusException if status transition is invalid
     */
    Order markOrderAsProcessing(UUID orderId);

    /**
     * Mark order as completed.
     * This happens when payment is confirmed and stock items are delivered.
     * 
     * @param orderId the order ID to update
     * @return the updated order
     * @throws com.accountselling.platform.exception.ResourceNotFoundException if order not found
     ...
     * This happens when payment fails or other processing errors occur.
     * 
     * @param orderId the order ID to update
    ...
    /**
     * Cancel order.
     * This releases reserved stock items and cancels associated payment.
     * 
     * @param orderId the order ID to cancel
     * @param reason the reason for cancellation
     * @return the updated order
     * @throws com.accountselling.platform.exception.ResourceNotFoundException if order not found
     * @throws com.accountselling.platform.exception.InvalidOrderStatusException if order cannot be cancelled
     */
    Order cancelOrder(UUID orderId, String reason);

    /**
     * Cancel order by user.
     * Allows users to cancel their own orders with validation.
     * 
     * @param orderId the order ID to cancel
     ...
     * @return the updated order
     * @throws com.accountselling.platform.exception.ResourceNotFoundException if order not found
     * @throws com.accountselling.platform.exception.UnauthorizedException if user doesn't own the order
     * @throws com.accountselling.platform.exception.InvalidOrderStatusException if order cannot be cancelled
     */
     ...
     * Checks product availability, user eligibility, and business rules.
     * 
     * @param user the user creating the order
     * @param productQuantities map of product IDs to quantities requested
     ...
     * Validates user status and restrictions.
     * 
    ...
    /**
     * Calculate total amount for products and quantities.
     * Used for order total calculation before creation.
     * 
     ...
     * Returns the number of available stock items for a product.
     * 
     ...
     * Internal method for stock reservation during order creation.
     * 
     ...
     * Releases all stock items reserved for a cancelled order.
     * 
    ...
    /**
     * Mark stock items as sold for completed order.
     * Marks all stock items in an order as sold when payment is completed.
     * 
     ...
     */
    Page<Order> searchOrders(String orderNumber, String username, OrderStatus status,
     ...
     */
    List<DailyOrderStatistics> getDailyOrderStatistics(LocalDateTime startDate, LocalDateTime endDate);
    ...
    /**
     * Process order completion from payment service.
     ...
     * @throws com.accountselling.platform.exception.ResourceNotFoundException if order not found
     * @throws com.accountselling.platform.exception.InvalidOrderStatusException if order cannot be completed
     */
    void processOrderCompletion(UUID orderId, String paymentTransactionId);

    /**
     * Process order failure from payment service.
    ...
    /**
     * Get order download information for completed order.
     * Returns stock credentials and information for completed orders.
     * 
     ...
     * @throws com.accountselling.platform.exception.ResourceNotFoundException if order not found
     * @throws com.accountselling.platform.exception.UnauthorizedException if user doesn't own the order
     * @throws com.accountselling.platform.exception.InvalidOrderStatusException if order is not completed
     */
