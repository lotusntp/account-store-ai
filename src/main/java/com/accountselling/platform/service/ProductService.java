...
/**
 * Service interface for Product management operations. Provides business logic for product search,
 * filtering, inventory management, and CRUD operations.
 *
 * <p>Interface for product management Supports search, filtering, stock management, and product
 * data operations
 */
public interface ProductService {
  ...
  /**
   * Search products by name with pagination. Supports Thai language search
   *
   ...
   */
  Page<Product> findProductsWithAvailableStockByCategory(
   ...
   * @throws com.accountselling.platform.exception.ResourceAlreadyExistsException if product name
   *     already exists
   ...
   * @throws com.accountselling.platform.exception.ResourceNotFoundException if product or category
   *     not found
