...
/**
 * Service interface for user management operations. Extends UserDetailsService for Spring Security
 * integration.
 *
 * <p>Service for user management and Spring Security integration
 */
