 ...
 * 
 * Service for automated inventory management operations.
 * Supports scheduled tasks for reservation cleanup and low stock notifications.
 */
@Slf4j
@Service
...
public class InventoryManagementService {
        ...
        try {
            ...
            if (!expiringSoon.isEmpty()) {
                ...
                for (Stock stock : expiringSoon) {
                    ...
                    log.warn("Stock reservation ID: {} for product '{}' will expire in {} minutes", 
        ...
        try {
            ...
            if (!lowStockProducts.isEmpty()) {
                ...
                for (Product product : lowStockProducts) {
                    ...
                    log.warn("Product '{}' has low stock: {} items (threshold: {})", 
    ...
    private void notifyReservationsExpiringSoon(List<Stock> expiringSoon) {
        ...
        for (Stock stock : expiringSoon) {
            log.info("Notification: Stock reservation ID {} will expire in {} minutes", 
    ...
    private void notifyLowStockProducts(List<Product> lowStockProducts) {
        ...
        for (Product product : lowStockProducts) {
            ...
            log.info("Notification: Product '{}' has low stock {} items (threshold: {})", 
                    product.getName(), availableStock, threshold);
        }
    }
