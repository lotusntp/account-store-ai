...
/**
 * DTO for payment refund requests.
 * Contains refund amount and reason for processing payment refunds.
 */
public record RefundRequestDto(
     ...
     * This can be determined by comparing with the original payment amount.
     * 
    ...
    public double getRefundPercentage(BigDecimal originalAmount) {
        ...
        return refundAmount.multiply(BigDecimal.valueOf(100))
