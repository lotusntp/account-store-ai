...
/**
 * DTO for updating existing products. Contains fields that can be updated for existing products.
 *
 * <p>DTO สำหรับการอัปเดตสินค้าที่มีอยู่ ประกอบด้วยฟิลด์ที่สามารถอัปเดตได้สำหรับสินค้าที่มีอยู่
 */
@Data
@Builder
@NoArgsConstructor
