...
/**
 * DTO for creating new products. Contains all required and optional fields for product creation.
 *
 * <p>DTO สำหรับการสร้างสินค้าใหม่ ประกอบด้วยฟิลด์ที่จำเป็นและทางเลือกสำหรับการสร้างสินค้า
 */
@Data
@Builder
@NoArgsConstructor
