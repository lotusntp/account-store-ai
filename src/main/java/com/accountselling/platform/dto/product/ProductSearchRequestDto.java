...
/**
 * DTO for product search and filtering requests. Used in REST API endpoints for advanced product
 * search functionality.
 *
 * <p>DTO สำหรับการค้นหาและกรองสินค้า ใช้ใน REST API endpoints สำหรับฟังก์ชันค้นหาสินค้าแบบขั้นสูง
 */
@Data
@Builder
@NoArgsConstructor
...
public class ProductSearchRequestDto {
  ...
  @Builder.Default private Boolean includeSubcategories = false;
  ...
  @Builder.Default private Boolean activeOnly = true;
  ...
  /** Check if any search criteria is provided. ตรวจสอบว่ามีเกณฑ์การค้นหาใดๆ ถูกระบุหรือไม่ */
  ...
  /** Check if price filtering is enabled. ตรวจสอบว่าเปิดใช้งานการกรองตามราคาหรือไม่ */
