 ...
 * Contains category data with hierarchical information.
 * 
 * DTO สำหรับข้อมูลหมวดหมู่ใน API responses
 * ประกอบด้วยข้อมูลหมวดหมู่พร้อมข้อมูลลำดับชั้น
 */
@Data
@Builder
@NoArgsConstructor
...
public class CategoryResponseDto {
     ...
     * ตรวจสอบว่าเป็นหมวดหมู่รากหรือไม่
     */
    ...
    /**
     * Get display status for the category.
     * ดึงสถานะการแสดงผลของหมวดหมู่
     */
