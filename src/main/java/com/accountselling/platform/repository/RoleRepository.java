 ...
 * Provides data access methods for role management functionality.
 * 
 * รีพอสิทอรี่สำหรับจัดการข้อมูลบทบาทผู้ใช้
 */
@Repository
public interface RoleRepository extends JpaRepository<Role, Long> {
     ...
     * Used for admin role search functionality.
     * 
     ...
     * Used for role management and cleanup operations.
     * 
     ...
     * Used for role statistics and reporting.
     * 
     ...
     * Used for consistent role listing in admin interfaces.
     * 
