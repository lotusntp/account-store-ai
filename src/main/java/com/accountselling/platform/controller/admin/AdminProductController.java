...
/**
 * Admin controller for product management operations. Provides CRUD operations for products with
 * admin privileges.
 *
 * <p>Admin controller สำหรับการจัดการสินค้า ให้บริการ CRUD operations สำหรับสินค้าด้วยสิทธิ์ admin
 */
@RestController
...
public class AdminProductController {
  ...
  @Operation(
      ...
      description =
          "Retrieve all products including inactive ones with pagination. Admin only endpoint.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  public ResponseEntity<Page<ProductResponseDto>> getAllProducts(
    ...
    log.info(
        "Admin getting all products - page: {}, size: {}, activeOnly: {}", page, size, activeOnly);
    ...
    log.info(
        "Admin retrieved {} products out of {} total",
  ...
  public ResponseEntity<ProductResponseDto> createProduct(
      @Parameter(description = "Product creation data", required = true) @Valid @RequestBody
    ...
    log.info(
        "Admin created product: {} with id: {}", createdProduct.getName(), createdProduct.getId());
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "400",
            description = "Invalid product data or no fields to update"),
        @ApiResponse(responseCode = "403", description = "Access denied - admin role required"),
  ...
  public ResponseEntity<ProductResponseDto> updateProduct(
      @Parameter(description = "Product ID", required = true) @PathVariable UUID id,
      @Parameter(description = "Product update data", required = true) @Valid @RequestBody
  ...
  public ResponseEntity<ProductResponseDto> moveProductToCategory(
      @Parameter(description = "Product ID", required = true) @PathVariable UUID id,
      @Parameter(description = "New category ID", required = true) @RequestParam UUID categoryId) {
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "400",
            description = "Product cannot be deleted (has pending orders or stock)"),
        @ApiResponse(responseCode = "403", description = "Access denied - admin role required"),
        @ApiResponse(responseCode = "404", description = "Product not found"),
        @ApiResponse(responseCode = "500", description = "Internal server error")
      })
  ...
  @Operation(
      ...
      description =
          "Retrieve products in a specific category including inactive ones. Admin only endpoint.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  public ResponseEntity<Page<ProductResponseDto>> getProductsByCategory(
    ...
    log.info(
        "Admin getting products by category: {} with includeSubcategories: {}, activeOnly: {}",
        categoryId,
    ...
    log.info(
        "Admin retrieved {} products for category: {}", response.getNumberOfElements(), categoryId);
    return ResponseEntity.ok(response);
  }
  ...
  @Operation(
      ...
      description =
          "Retrieve list of distinct server names from all products. Admin only endpoint.")
  @ApiResponses(
      value = {
  ...
  /** Convert Product entity to ProductResponseDto. แปลง Product entity เป็น ProductResponseDto */
