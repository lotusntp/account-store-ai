...
/**
 * Admin dashboard controller providing comprehensive system statistics and overview. Aggregates
 * data from all services to provide admin dashboard insights.
 *
 * <p>Admin dashboard controller ให้ข้อมูลสถิติระบบและภาพรวมแบบครอบคลุม รวบรวมข้อมูลจากทุก services
 * เพื่อให้ข้อมูลเชิงลึกสำหรับแดชบอร์ด admin
 */
@RestController
...
@Tag(
    ...
    description = "Admin dashboard endpoints for system overview and statistics")
...
public class AdminDashboardController {
  ...
  @Operation(
      ...
      description =
          "Get comprehensive dashboard data including all key metrics. Admin only endpoint.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Get daily trends for orders and revenue over specified period. Admin only endpoint.")
  @ApiResponses(
      value = {
  ...
  public ResponseEntity<List<DailyOrderStatistics>> getDailyTrends(
    ...
    List<DailyOrderStatistics> dailyTrends =
        orderService.getDailyOrderStatistics(startDate, endDate);
  ...
  /** Build user statistics. สร้างสถิติผู้ใช้ */
  private AdminDashboardDto.UserStats buildUserStats(
      LocalDateTime startOfDay, LocalDateTime startOfWeek) {
  ...
  /** Build order statistics. สร้างสถิติคำสั่งซื้อ */
  private AdminDashboardDto.OrderStats buildOrderStats(
      LocalDateTime startOfDay, LocalDateTime startOfWeek) {
  ...
  /** Build product statistics. สร้างสถิติผลิตภัณฑ์ */
  ...
  /** Build stock statistics. สร้างสถิติสต็อก */
  ...
  /** Build revenue statistics. สร้างสถิติรายได้ */
  private AdminDashboardDto.RevenueStats buildRevenueStats(
      LocalDateTime startOfDay, LocalDateTime startOfWeek, LocalDateTime startOfMonth) {
    ...
    OrderStatistics previousMonthStats =
        orderService.getOrderStatistics(previousMonthStart, startOfMonth);
  ...
  /** Build system information. สร้างข้อมูลระบบ */
