 ...
 * Links orders to specific products and stock items that were purchased.
 * 
 * เอนทิตี้รายการสินค้าในคำสั่งซื้อที่แสดงสินค้าแต่ละรายการในคำสั่งซื้อ
...
@Setter
@NoArgsConstructor
@ToString(callSuper = true, exclude = {"order", "product", "stockItem"})
...
public class OrderItem extends BaseEntity {
    ...
    public boolean isValidStockItemForProduct() {
        return stockItem != null && product != null && 
