...
/**
 * Category entity representing product categories with hierarchical structure.
 * Supports parent-child relationships for organizing products into categories and subcategories.
 * 
 * เอนทิตี้หมวดหมู่สินค้าที่มีโครงสร้างแบบลำดับชั้น
 * รองรับความสัมพันธ์แบบพ่อแม่-ลูก สำหรับจัดระเบียบสินค้าในหมวดหมู่และหมวดหมู่ย่อย
 */
@Entity
