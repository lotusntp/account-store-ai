...
/**
 * Stock entity representing individual account credentials available for sale.
 * Each stock item contains encrypted credentials for a specific product.
 * 
 * เอนทิตี้สต็อกที่แสดงข้อมูลบัญชีแต่ละรายการที่มีจำหน่าย
...
@Setter
@NoArgsConstructor
@ToString(callSuper = true, exclude = {"product", "credentials"})
