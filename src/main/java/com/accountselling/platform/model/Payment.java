...
/**
 * Payment entity representing payment information for orders. Contains payment details including
 * amount, status, method, and external transaction references.
 *
 * <p>เอนทิตี้การชำระเงินที่แสดงข้อมูลการชำระเงินสำหรับคำสั่งซื้อ ประกอบด้วยรายละเอียดการชำระเงิน
 * รวมถึงจำนวนเงิน สถานะ วิธีการชำระเงิน และการอ้างอิงธุรกรรมภายนอก
 */
@Entity
@Table(
    name = "payments",
...
public class Payment extends BaseEntity {
  ...
  @Digits(
      integer = 12,
      fraction = 2,
      message = "Payment amount must have at most 12 integer digits and 2 decimal places")
  ...
  public boolean isAmountValid() {
    return order != null && amount != null && amount.compareTo(order.getTotalAmount()) == 0;
  }
}
