 ...
 * Represents different states a payment can be in during processing.
 * 
 * enum สถานะการชำระเงินสำหรับติดตามวงจรชีวิตของการชำระเงิน
 * แสดงสถานะต่างๆ ที่การชำระเงินสามารถอยู่ได้ระหว่างการประมวลผล
 */
