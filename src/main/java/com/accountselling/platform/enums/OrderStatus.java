 ...
 * Represents different states an order can be in during processing.
 * 
 * enum สถานะคำสั่งซื้อสำหรับติดตามวงจรชีวิตของคำสั่งซื้อ
 * แสดงสถานะต่างๆ ที่คำสั่งซื้อสามารถอยู่ได้ระหว่างการประมวลผล
 */
