...
/**
 * Unit tests for UserServiceImpl. Tests user registration, authentication, and management
 * functionality.
 */
...
class UserServiceImplTest {
  ...
  void registerUser_WithValidData_ShouldCreateUser() {
    ...
    User result =
        userService.registerUser("newuser", "password123", "new@example.com", "New", "User");
  ...
  void updateUserProfile_WithValidData_ShouldUpdateUser() {
    ...
    User result =
        userService.updateUserProfile(userId, "newemail@example.com", "NewFirst", "NewLast");
    ...
    assertThatThrownBy(
            () ->
                userService.updateUserProfile(
                    userId, "existing@example.com", "NewFirst", "NewLast"))
        .isInstanceOf(ResourceAlreadyExistsException.class)
        .hasMessageContaining("Email already exists: existing@example.com");
