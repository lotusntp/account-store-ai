...
/**
 * Unit tests for ProductServiceImpl. Tests product management functionality including search,
 * filtering, stock operations, and CRUD.
 *
 * <p>ProductServiceImpl testing Tests product management functions including search, filtering,
 * stock management, and data operations
 */
...
class ProductServiceImplTest {
  ...
  void setUp() {
    ...
    testProduct1 =
        new Product("World of Warcraft Account", new BigDecimal("1500.00"), testCategory);
    ...
    testProduct2 =
        new Product("Final Fantasy XIV Account", new BigDecimal("2000.00"), testCategory);
  ...
  void findProductsByPriceRange_WithValidRange_ShouldReturnProductsInRange() {
    ...
    when(productRepository.findActiveByPriceBetween(minPrice, maxPrice, pageable))
        .thenReturn(productPage);

    Page<Product> result =
        productService.findProductsByPriceRange(minPrice, maxPrice, true, pageable);
  ...
  void createProduct_WithValidData_ShouldCreateProduct() {
    ...
    Product result =
        productService.createProduct(name, description, price, categoryId, server, imageUrl);
  ...
  void updateProduct_WithValidData_ShouldUpdateProduct() {
    ...
    Product result =
        productService.updateProduct(
            productId, newName, newDescription, newPrice, null, null, null);
  ...
  void reorderProducts_WithValidProducts_ShouldUpdateSortOrder() {
    ...
    when(productRepository.saveAll(anyList()))
        .thenReturn(Arrays.asList(testProduct2, testProduct1));
  ...
  void productSearchCriteria_WithName_ShouldSetName() {
    ...
    ProductService.ProductSearchCriteria criteria =
        new ProductService.ProductSearchCriteria(searchName);
  ...
  void productStockInfo_WithValidData_ShouldCreateCorrectly() {
    ...
    ProductService.ProductStockInfo stockInfo =
