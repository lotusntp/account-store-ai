 ...
 * 
 * Integration tests สำหรับ CategoryController
...
class CategoryControllerIntegrationTest {
    ...
    void shouldGetAllCategoriesIncludingInactive() throws Exception {
        mockMvc.perform(get("/api/categories")
                ...
                .andExpect(jsonPath("$[*].name", hasItems("Gaming Accounts", "MMORPG", "FPS Games", "Discontinued Games")))
    ...
    void shouldGetCategoryByIdWithSubcategories() throws Exception {
        mockMvc.perform(get("/api/categories/{id}", rootCategory.getId())
                        .contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
                .andExpect(status().isOk())
    ...
    void shouldGetSubcategoryByIdWithParentInfo() throws Exception {
        mockMvc.perform(get("/api/categories/{id}", subCategory1.getId())
                        .contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
                .andExpect(status().isOk())
    ...
    void shouldGetSubcategoriesOfParentCategory() throws Exception {
        mockMvc.perform(get("/api/categories/{parentId}/subcategories", rootCategory.getId())
                        .param("activeOnly", "true")
                        .contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
                .andExpect(status().isOk())
    ...
    void shouldReturnEmptyListWhenParentHasNoSubcategories() throws Exception {
        mockMvc.perform(get("/api/categories/{parentId}/subcategories", subCategory1.getId())
                        .contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
                .andExpect(status().isOk())
    ...
    void shouldReturn404WhenParentCategoryNotFoundForSubcategories() throws Exception {
        ...
        mockMvc.perform(get("/api/categories/{parentId}/subcategories", nonExistentParentId)
                        .contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
                .andExpect(status().isNotFound());
    }
    ...
    void shouldGetCategoryPathFromRootToLeaf() throws Exception {
        mockMvc.perform(get("/api/categories/{id}/path", subCategory1.getId())
                        .contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$", hasSize(2)))
    ...
    void shouldGetSingleItemPathForRootCategory() throws Exception {
        mockMvc.perform(get("/api/categories/{id}/path", rootCategory.getId())
                        .contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$", hasSize(1)))
    ...
    void shouldReturn404WhenCategoryNotFoundForPath() throws Exception {
        ...
        mockMvc.perform(get("/api/categories/{id}/path", nonExistentId)
                        .contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
                .andExpect(status().isNotFound());
    }
