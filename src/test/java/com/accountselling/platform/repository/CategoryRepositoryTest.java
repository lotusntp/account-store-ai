 ...
 * Tests repository methods for category management functionality including
...
class CategoryRepositoryTest {
    ...
    void findByParentCategoryId_ShouldReturnSubcategoriesOrderedBySortAndName() {
        ...
        assertThat(subcategories).allMatch(category -> 
            category.getParentCategory().getId().equals(rootCategory.getId()));
    }
    ...
    void findActiveByParentCategoryId_ShouldReturnActiveSubcategories() {
        ...
        // When
        List<Category> activeSubcategories = categoryRepository.findActiveByParentCategoryId(rootCategory.getId());
    ...
    void findByNameContainingIgnoreCaseAndActive_ShouldReturnMatchingActiveCategories() {
        ...
        // When
        List<Category> results = categoryRepository.findByNameContainingIgnoreCaseAndActive("game", true);
    ...
    void countActiveProductsByCategoryId_ShouldReturnCorrectCount() {
        ...
        Product inactiveProduct = new Product("Inactive Product", new BigDecimal("20.00"), rootCategory);
    ...
    void findAllByOrderByNameAsc_ShouldReturnCategoriesOrderedByName() {
        ...
        assertThat(orderedCategories).extracting(Category::getName)
    ...
    void save_ShouldPersistCategoryWithHierarchy() {
        ...
        assertThat(savedCategory.getSubCategories()).extracting(Category::getName)
    ...
    void findDirectSubcategories_ShouldReturnDirectSubcategories() {
        ...
        assertThat(directSubs).extracting(Category::getName)
