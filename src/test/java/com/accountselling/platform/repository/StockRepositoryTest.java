...
/**
 * Comprehensive unit tests for StockRepository.
...
class StockRepositoryTest {
    ...
    void shouldFindStockItemsByProduct() {
        ...
        assertThat(result)
            ...
            .containsExactlyInAnyOrder("username1:password1", "username2:password2", "username3:password3");
    }
    ...
    void shouldFindAvailableStockItems() {
        ...
        assertThat(result)
            .extracting(Stock::getCredentials)
            .containsExactlyInAnyOrder("username1:password1", "username2:password2", "username5:password5");
    }
    ...
    void shouldReturnEmptyWhenNoAvailableStockExists() {
        ...
        Product productWithoutStock = new Product("No Stock Product", new BigDecimal("50.00"), testCategory);
    ...
    void shouldFindSoldStockItemsByProductWithinDateRange() {
        ...
        // When
        List<Stock> result = stockRepository.findSoldByProductBetweenDates(testProduct1, startDate, endDate);
    ...
    void shouldCheckIfStockExistsWithSpecificCredentials() {
        // When & Then
        assertThat(stockRepository.existsByProductIdAndCredentials(testProduct1.getId(), "username1:password1"))
            .isTrue();
        assertThat(stockRepository.existsByProductIdAndCredentials(testProduct1.getId(), "nonexistent:credentials"))
            .isFalse();
        assertThat(stockRepository.existsByProductIdAndCredentials(testProduct2.getId(), "username1:password1"))
            .isFalse();
    }
    ...
    void shouldFindOldestUnsoldStockByProduct() {
        ...
        assertThat(result.get().getCredentials())
            .isIn("username1:password1", "username2:password2");
    }
    ...
    void shouldFindStockCreatedWithinDateRange() {
        ...
        assertThat(result).allSatisfy(stock -> 
            assertThat(stock.getCreatedAt()).isBetween(startDate, endDate)
        );
    }
